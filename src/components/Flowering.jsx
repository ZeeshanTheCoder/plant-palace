...
import Flower from "../components/data/Flower.json"
...
const Flowering = () => {
    ...
    const [filteredProducts, setFilteredProducts] = useState(Flower);
    ...
    const handleSearch = (e) => {
        ...
        const filtered = Flower.filter(product =>
